// OAIA Digital - Contractor Advances & Payments
          ...
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="text-oaia-gray mt-1">
                Track your advance payments, final payments, and repayments
              </p>
            </div>
                      ...
                      <div>
                        ...
                        <div className="text-xs text-oaia-gray">
                          ...
                          {transaction.percentage &&
                            `${transaction.percentage} of invoice`}
                        </div>
                      </div>
                    </div>
