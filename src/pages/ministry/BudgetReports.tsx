...
const BudgetReports = () => {
  ...
  const agencyBudgetData = [
    { name: 'GETFund', allocated: 50000000, utilized: 39000000, remaining: 11000000, color: '#1E40AF' },
    { name: 'NHIS', allocated: 40000000, utilized: 26000000, remaining: 14000000, color: '#EA580C' },
    { name: 'Road Fund', allocated: 60000000, utilized: 51000000, remaining: 9000000, color: '#16A34A' },
    { name: 'Education', allocated: 35000000, utilized: 25200000, remaining: 9800000, color: '#DC2626' }
  ];
  ...
  return (
    <div className="min-h-screen bg-oaia-light">
      <header className="bg-white border-b shadow-sm">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            <span className="text-sm text-oaia-gray">Ministry of Finance - Budget Reports</span>
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900">Budget Reports & Analytics</h1>
          <p className="text-oaia-gray mt-1">Generate comprehensive financial reports and forecasts</p>
        </div>
        ...
        <div className="grid md:grid-cols-4 gap-6 mb-8">
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold text-oaia-blue">KES 185M</div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold text-oaia-green">KES 141.2M</div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold text-yellow-600">KES 2.5M</div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold text-oaia-blue">KES 1.8M</div>
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-8">
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-xl text-oaia-blue">Monthly Expenditure vs Budget</CardTitle>
              <CardDescription>
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-xl text-oaia-blue">Cashflow Projection</CardTitle>
              <CardDescription>
              ...
              <div className="h-80">
                <ResponsiveContainer width="100%" height="100%">
                  <LineChart data={cashflowProjection}>
                    ...
                    <YAxis />
                    <Tooltip formatter={(value) => `KES ${(value as number).toLocaleString()}`} />
                    <Line type="monotone" dataKey="inflow" stroke="#16A34A" name="Inflow" strokeWidth={2} />
                    <Line type="monotone" dataKey="outflow" stroke="#DC2626" name="Outflow" strokeWidth={2} />
                    <Line type="monotone" dataKey="balance" stroke="#1E40AF" name="Balance" strokeWidth={2} />
                  </LineChart>
                </ResponsiveContainer>
              </div>
            </CardContent>
        ...
        <Card className="mb-8">
          <CardHeader>
            <CardTitle className="text-xl text-oaia-blue">Agency Budget Utilization</CardTitle>
            <CardDescription>
              ...
              {agencyBudgetData.map((agency) => (
                <div key={agency.name} className="p-4 border rounded-lg">
                  <div className="flex items-center justify-between mb-3">
                    <div>
                      ...
                      <p className="text-sm text-gray-500">
                        Allocated: KES {(agency.allocated / 1000000).toFixed(1)}M
                      </p>
                    </div>
                    <div className="text-right">
                      <div className="text-lg font-bold text-oaia-blue">
                        {((agency.utilized / agency.allocated) * 100).toFixed(1)}%
                      </div>
                      <div className="text-sm text-gray-500">
                        KES {(agency.utilized / 1000000).toFixed(1)}M utilized
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex justify-between text-sm text-gray-600 mt-2">
                    <span>Remaining: KES {(agency.remaining / 1000000).toFixed(1)}M</span>
        ...
        <Card>
          <CardHeader>
            <div className="flex items-center justify-between">
              <div>
                <CardTitle className="text-xl text-oaia-blue">Report Templates</CardTitle>
                <CardDescription>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              {reportTemplates.map((template) => (
                <div key={template.id} className="p-4 border rounded-lg hover:shadow-md transition-shadow">
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-sm text-gray-600">Format: {template.format}</span>
                    <div className="flex space-x-2">
