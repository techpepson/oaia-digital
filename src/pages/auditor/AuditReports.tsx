...
const AuditReports = () => {
  ...
  const customReports = [
    ...
    },
    {
      ...
      description: 'Investigation report on duplicate payments across multiple agencies',
    ...
    <div className="min-h-screen bg-oaia-light">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-oaia-gray mt-1">Generate, access, and manage audit reports and data extracts</p>
        </div>
        ...
        <Card className="mb-8">
          <CardHeader>
            <CardTitle className="text-xl text-oaia-blue">Pre-defined Audit Reports</CardTitle>
            <CardDescription>Instantly generate standard audit reports with current data</CardDescription>
          </CardHeader>
          <CardContent>
                  ...
                  <CardContent>
                    <div className="space-y-3">
                      <div className="flex justify-between text-sm">
                        <span className="text-oaia-gray">Last Generated:</span>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-xl text-oaia-blue">Custom Audit Reports</CardTitle>
            <CardDescription>User-created reports and specialized investigations</CardDescription>
          </CardHeader>
          <CardContent>
                ...
                <div key={report.id} className="flex items-center justify-between p-4 border rounded-lg hover:bg-gray-50 transition-colors">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-oaia-gray">{report.description}</div>
                  ...
                  <div className="flex items-center space-x-4">
                    <div className="text-right">
                      <div className="text-sm font-medium">{report.findings} findings</div>
                      <div className="text-sm text-oaia-gray">{report.pages} pages</div>
                    </div>
            ...
            {filteredCustom.length === 0 && (
              <div className="text-center py-12">
                ...
                <p className="text-oaia-gray mb-4">Create your first custom audit report to get started.</p>
                <Button>
                  <Plus className="h-4 w-4 mr-2" />
