...
const InvoiceRegistry = () => {
  ...
  const filteredInvoices = invoices.filter(invoice => {
    ...
    const matchesAgency = agencyFilter === 'all' || invoice.agency.toLowerCase().includes(agencyFilter.toLowerCase());
    ...
    <div className="min-h-screen bg-oaia-light">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-oaia-gray mt-1">Complete ledger of all invoices and payments (Read-Only Access)</p>
        </div>
        ...
        <div className="grid md:grid-cols-4 gap-6 mb-8">
          ...
          <Card>
            <CardHeader className="pb-3">
              <CardTitle className="text-sm font-medium text-oaia-gray">Flagged Invoices</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="text-2xl font-bold text-red-600">
                {invoices.filter(inv => inv.status === 'flagged').length}
              </div>
              <div className="text-sm text-oaia-gray">Requiring attention</div>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold text-green-600">KES 4.2M</div>
          ...
          <Card>
            <CardHeader className="pb-3">
              <CardTitle className="text-sm font-medium text-oaia-gray">Under Investigation</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="text-2xl font-bold text-orange-600">
                {invoices.filter(inv => inv.auditStatus === 'investigating').length}
              </div>
              ...
              <CardContent className="p-6">
                <div className="flex items-start justify-between mb-4">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="text-lg font-medium text-oaia-blue">{invoice.id}</h3>
                      <p className="text-sm text-oaia-gray">{invoice.description}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <Badge className={getAuditStatusColor(invoice.auditStatus)}>
                ...
                <div className="grid md:grid-cols-4 gap-6">
                  <div className="space-y-2">
                    ...
                    <div className="text-sm text-oaia-gray">ID: {invoice.contractorId}</div>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="text-sm text-oaia-gray">Contract: {invoice.contractValue}</div>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    {invoice.paymentDate && (
                      <div className="text-sm text-green-600">Paid: {invoice.paymentDate}</div>
                    )}
                  </div>
                </div>
                ...
                {invoice.flags.length > 0 && (
                  <div className="mt-4 p-3 bg-red-50 border border-red-200 rounded">
                    ...
                    <div className="text-sm text-red-700">
                      {invoice.flags.map(flag => flag.replace('-', ' ')).join(', ')}
                    </div>
                  </div>
                )}
        ...
        {filteredInvoices.length === 0 && (
          <Card className="text-center py-12">
            <CardContent>
              ...
              <p className="text-oaia-gray">Try adjusting your search criteria.</p>
            </CardContent>
          </Card>
        )}
      </div>
