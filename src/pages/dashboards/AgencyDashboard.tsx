...
const AgencyDashboard = () => {
  ...
  const budgetAlerts = [
    ...
    },
    {
      ...
      message:
        "Invoice INV-2024-010 exceeds approved contract milestone amount",
                    ...
                    >
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex items-center justify-between mt-1">
                          ...
                          <p className="text-xs font-medium text-oaia-blue">
                            {activity.amount}
                          </p>
                        </div>
                      </div>
