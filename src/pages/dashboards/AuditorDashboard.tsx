// OAIA Digital - Auditor Dashboard
        ...
        <div className="container mx-auto px-4 py-8 flex-1">
                ...
                <div className="flex items-center justify-between p-3 bg-white rounded border-l-4 border-l-red-500">
                  <div>
                    ...
                    <p className="text-sm text-red-700">
                      Invoice INV-2024-156 exceeds contract limit by 40%
                    </p>
                  </div>
                ...
                <div className="flex items-center justify-between p-3 bg-white rounded border-l-4 border-l-orange-500">
                  <div>
                    ...
                    <p className="text-sm text-orange-700">
                      Similar invoices from same contractor detected
                    </p>
                  </div>
                  <Button size="sm" variant="outline">
                    <Eye className="h-4 w-4 mr-1" />
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <CardDescription>
                    Investigations and reviews in progress
                  </CardDescription>
                </div>
                <Button size="sm">
                  <FileSearch className="h-4 w-4 mr-2" />
                  ...
                  >
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        ...
                        <div className="text-sm font-medium text-oaia-blue">
                          {auditCase.title}
                        </div>
                        <div className="text-sm text-oaia-gray">
                          {auditCase.agency} • {auditCase.amount} • Assigned to:{" "}
                          {auditCase.assignee}
                        </div>
                      </div>
                    </div>
          ...
          <Card className="mb-8">
            <CardHeader>
              ...
              <CardDescription>
                Search and analyze all invoices with advanced filtering
              </CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Card>
            ...
            <CardContent>
                  ...
                  >
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-oaia-gray">
                          {invoice.contractor} • {invoice.agency}
                        </div>
              ...
              <div className="mt-6 flex justify-center">
                <Button variant="outline">View All Flagged Invoices</Button>
              </div>
            </CardContent>
          </Card>
        </div>
